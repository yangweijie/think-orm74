...
if (!function_exists('db')) {
    /**
     * @param string|mixed[]|null $connect
     */
    function db(string $name, $connect = null): Query
    {
        if ($connect) {
...
if (!function_exists('inc')) {
     ...
     */
    function inc($step = 1, int $lazyTime = 0): Express
    {
...
if (!function_exists('dec')) {
     ...
     * @param float|int $step
     */
    function dec($step = 1, int $lazyTime = 0): Express
    {
        return new Express('-', $step, $lazyTime);
    }
}
