        ...
        foreach ($this->getOption('append') as $key => $field) {
            if (is_numeric($key)) {
                if (strpos($field, '.')) {
                    ...
                    $value    = ($nullsafeVariable1 = $relation) ? $nullsafeVariable1->get($field) : null;
                } else {
                ...
                foreach((array) $field as $key => $name) {
                    if (is_numeric($key)) {
                        $item[$name] = ($nullsafeVariable2 = $relation) ? $nullsafeVariable2->get($name) : null;
                    } else {
                        $item[$name] = ($nullsafeVariable3 = $relation) ? $nullsafeVariable3->get($key) : null;
                    }
                }
            } 
        }
