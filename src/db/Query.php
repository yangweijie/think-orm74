...
class Query extends BaseQuery
{
     ...
     * @return int|false
     */
    public function setInc(string $field, $step = 1, int $lazyTime = 0)
    {
     ...
     * @return int|false
     */
    public function setDec(string $field, $step = 1, int $lazyTime = 0)
    {
     ...
     */
    public function lazyWrite(string $field, string $type, $step, int $lazyTime)
    {
