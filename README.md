...
基于PHP7.4+ 和PDO实现的轻量级ORM，完全重构的Model层，支持实体模型和分层（[新特性盘点](https://doc.thinkphp.cn/@think-orm/v4_0/new-features.html)），并基本兼容3.0（参考[升级指导](https://doc.thinkphp.cn/@think-orm/v4_0/upgrade.html)）。
